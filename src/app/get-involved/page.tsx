          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-lg shadow-md">
                <h3 className="text-2xl font-bold text-[#892626] mb-4">Partner with Us</h3>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                <h3 className="text-2xl font-bold text-[#892626] mb-4">Volunteer</h3>
                <p className="text-gray-700 mb-6">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                <h3 className="text-2xl font-bold text-[#892626] mb-4">Donate</h3>
                <p className="text-gray-700 mb-6">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                <h3 className="text-2xl font-bold text-[#892626] mb-4">Spread the Word</h3>
                <p className="text-gray-700 mb-6">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-[#892626] hover:text-[#F08232]">
